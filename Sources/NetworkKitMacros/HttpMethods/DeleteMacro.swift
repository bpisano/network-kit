...
public struct DeleteMacro: MemberMacro, ExtensionMacro {
    ...
    public static func expansion(
        ...
        // Extract the path and response type arguments from the @Delete macro
        guard
    ...
    /// Extracts the path and response type arguments from the @Delete macro attribute
            ...
            context.diagnose(
                .init(
                    ...
                    message: MacroExpansionErrorMessage(
                        "@Delete requires a string literal path argument")
                )
            )
            return nil
        }
