...
public struct HeadMacro: MemberMacro, ExtensionMacro {
    ...
    public static func expansion(
        ...
        // Extract the path and response type arguments from the @Head macro
        guard
    ...
    /// Extracts the path and response type arguments from the @Head macro attribute
            ...
            context.diagnose(
                .init(
                    ...
                    message: MacroExpansionErrorMessage(
                        "@Head requires a string literal path argument")
                )
            )
            return nil
        }
