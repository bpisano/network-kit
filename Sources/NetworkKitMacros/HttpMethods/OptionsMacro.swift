...
public struct OptionsMacro: MemberMacro, ExtensionMacro {
    ...
    public static func expansion(
        ...
        // Extract the path and response type arguments from the @Options macro
        guard
    ...
    /// Extracts the path and response type arguments from the @Options macro attribute
            ...
            context.diagnose(
                .init(
                    ...
                    message: MacroExpansionErrorMessage(
                        "@Options requires a string literal path argument")
                )
            )
            return nil
        }
