...
public struct PutMacro: MemberMacro, ExtensionMacro {
    ...
    public static func expansion(
        ...
        // Extract the path and response type arguments from the @Put macro
        guard
    ...
    /// Extracts the path and response type arguments from the @Put macro attribute
            ...
            context.diagnose(
                .init(
                    ...
                    message: MacroExpansionErrorMessage(
                        "@Put requires a string literal path argument")
                )
            )
            return nil
        }
